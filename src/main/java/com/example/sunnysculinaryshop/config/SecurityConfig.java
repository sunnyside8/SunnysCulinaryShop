package com.example.sunnysculinaryshop.config;

import com.example.sunnysculinaryshop.repository.UserRepository;
import com.example.sunnysculinaryshop.service.ShopUsersDeteilsService;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService(UserRepository userRepository) {
        return new ShopUsersDeteilsService(userRepository);
    }
}
